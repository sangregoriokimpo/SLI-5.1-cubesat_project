...
VECTOR MATH CODE USING EIGEN LIBRARY
...
VECTOR MATH CODE, THIS IS DEPRECATED BECAUSE EIGEN LIBRARY DOES THE SAME THING, BUT MORE OPTIMIZED AND FASTER
...
static std::pair<V3,V3>rk4_step(double mu, V3 r, V3 v, double dt, V3 a_ext){
    ...
    V3 r3 = r + 0.5*dt*k2r; V3 v3 = v + 0.5*dt*k2v;
    V3 k3r = v3, k3v = accel(r3);
    V3 r4 = r + dt*k3r; V3 v4 = v + dt*k3v;
...
//DEPRECATED AS THIS FUNCTION DOESNT WORK WITH EIGEN
...
static Q4 q_integrate(Q4 q, V3 omega, double dt){
    ...
    //q_dot = 0.5 * q * om (HAMILTON PRODUCT)
    Q4 qd;
